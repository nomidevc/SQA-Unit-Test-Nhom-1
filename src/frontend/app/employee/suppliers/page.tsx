...
import { FiSearch, FiPhone, FiMail, FiMapPin, FiCreditCard, FiFileText, FiPlus } from 'react-icons/fi'
          ...
          <div className="flex items-start">
            ...
            <div>
              ...
              <p className="text-sm text-blue-700 mt-1">
                Bạn chỉ có quyền xem danh sách nhà cung cấp, không thể thêm hoặc chỉnh sửa.
              </p>
            </div>
          </div>
        </div>
