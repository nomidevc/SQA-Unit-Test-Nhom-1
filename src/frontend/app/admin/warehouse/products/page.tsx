...
export default function AdminWarehouseProductsPage() {
  ...
  return (
    <div className="p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <button
          onClick={() => router.push('/admin/warehouse/products/create')}
              ...
              <tr key={product.id} className="hover:bg-gray-50">
                ...
                <td className="px-6 py-4 whitespace-nowrap">
                  <div className="flex items-center gap-2">
                    <button
                      onClick={() => router.push(`/admin/warehouse/products/${product.id}`)}
                    ...
                    <button
                      onClick={() => router.push(`/admin/warehouse/products/${product.id}/edit`)}
