...
public class OrderServiceTest {
    ...
    public void setup() {
        ...
        Category cat = categoryRepository
                .save(Category.builder().name("Electronics").slug("electronics").active(true).build());
        product1 = productRepository.save(Product.builder().name("Laptop Pro").sku("LP").price(2000.0)
                .stockQuantity(10L).reservedQuantity(0L).active(true).category(cat).build());
        product2 = productRepository.save(Product.builder().name("Mouse Wireless").sku("MW").price(50.0)
                .stockQuantity(50L).reservedQuantity(0L).active(true).category(cat).build());
    ...
    @Test
    @DisplayName("TC_ORDER_01: Đặt hàng thành công từ giỏ hàng (COD)")
    public void tc01() {
        ...
        assertTrue(
                cartItemRepository.findByCartId(cartRepository.findByCustomerId(customerId).get().getId()).isEmpty());
    }

    @Test
    @DisplayName("TC_ORDER_02: Đặt hàng thành công (Online Payment - SEPAY)")
    public void tc02() {
        addToCart(customerId, product1, 1);
    ...
    @Test
    @DisplayName("TC_ORDER_03: Đặt hàng khi giỏ hàng trống")
    public void tc03() {
    ...
    @Test
    @DisplayName("TC_ORDER_04: Đặt hàng với sản phẩm hết hàng (Stock=0)")
    public void tc04() {
        Product outOfStock = productRepository
                .save(Product.builder().name("Old Phone").sku("OP").price(10.0).stockQuantity(0L).active(true).build());
    ...
    @Test
    @DisplayName("TC_ORDER_05: Đặt hàng với số lượng vượt tồn kho")
    public void tc05() {
    ...
    @Test
    @DisplayName("TC_ORDER_06: Đặt hàng chỉ chọn một vài sản phẩm trong giỏ")
    public void tc06() {
        ...
        // Bug TC_ORDER_06: Kiểm tra tình huống xóa nhầm toàn bộ sản phẩm trong giỏ khi
        // chỉ mua 1 phần
    ...
    @Test
    @DisplayName("TC_ORDER_07: Kiểm tra giữ hàng (Reserved Quantity) khi đặt hàng")
    public void tc07() {
    ...
    @Test
    @DisplayName("TC_ORDER_08: Đặt hàng với địa chỉ trống")
    public void tc08() {
        addToCart(customerId, product1, 1);
    ...
    @Test
    @DisplayName("TC_ORDER_09: Đặt hàng với phí ship âm (Hệ thống nên chặn hoặc xử lý)")
    public void tc09() {
        addToCart(customerId, product1, 1);
    ...
    @Test
    @DisplayName("TC_ORDER_10: Đặt hàng khi Product bị xóa giữa chừng")
    public void tc10() {
        addToCart(customerId, product1, 1);
    ...
    @Test
    @DisplayName("TC_ORDER_11: Mã đơn hàng (Order Code) phải duy nhất")
    public void tc11() {
        addToCart(customerId, product1, 1);
    ...
    @Test
    @DisplayName("TC_ORDER_12: Đặt hàng với Customer không tồn tại")
    public void tc12() {
        assertThrows(RuntimeException.class, () -> orderService.createOrderFromCart(9999L, createReq("A", "COD", 0.0)));
    }

    @Test
    @DisplayName("TC_ORDER_13: Đặt hàng với Giỏ hàng bị xóa (Mồ côi)")
    public void tc13() {
    ...
    @Test
    @DisplayName("TC_ORDER_14: Kiểm tra thông tin ghi chú (Note) lưu đúng")
    public void tc14() {
        addToCart(customerId, product1, 1);
    ...
    @Test
    @DisplayName("TC_ORDER_15: Đặt hàng với nhiều loại sản phẩm khác nhau")
    public void tc15() {
        addToCart(customerId, product1, 1);
    ...
    @Test
    @DisplayName("TC_ORDER_16: Lấy đơn hàng theo ID hợp lệ")
    public void tc16() {
    ...
    @Test
    @DisplayName("TC_ORDER_17: Lấy đơn hàng theo ID không tồn tại")
    public void tc17() {
        assertThrows(RuntimeException.class, () -> orderService.getOrderById(9999L, customerId));
    }

    @Test
    @DisplayName("TC_ORDER_18: SECURITY - Lấy đơn hàng của người khác theo ID")
    public void tc18() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_19: Lấy đơn hàng theo mã (Order Code) hợp lệ")
    public void tc19() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_20: Lấy đơn hàng theo mã không tồn tại")
    public void tc20() {
        assertThrows(RuntimeException.class, () -> orderService.getOrderByCode("INVALID_CODE", customerId));
    }

    @Test
    @DisplayName("TC_ORDER_21: SECURITY - Lấy đơn hàng người khác theo mã")
    public void tc21() {
        Long orderId = createSampleOrder(customerId);
        String code = orderRepository.findById(orderId).get().getOrderCode();
    ...
    @Test
    @DisplayName("TC_ORDER_22: Danh sách đơn hàng của tôi (My Orders)")
    public void tc22() {
    ...
    @Test
    @DisplayName("TC_ORDER_23: Danh sách đơn hàng khi chưa mua gì")
    public void tc23() {
    ...
    @Test
    @DisplayName("TC_ORDER_24: Admin lấy chi tiết đơn hàng (Không cần customerId)")
    public void tc24() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_25: Admin lấy danh sách đơn hàng lọc theo trạng thái")
    public void tc25() {
        createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_26: Cập nhật trạng thái sang CONFIRMED")
    public void tc26() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_27: Cập nhật trạng thái sang SHIPPING")
    public void tc27() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_28: Cập nhật trạng thái sang DELIVERED (Check PaymentStatus)")
    public void tc28() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_29: Cập nhật trạng thái không hợp lệ (String sai)")
    public void tc29() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_30: Mark as Shipping từ CONFIRMED")
    public void tc30() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "CONFIRMED");
    ...
    @Test
    @DisplayName("TC_ORDER_31: Mark as Shipping từ trạng thái sai (Ví dụ PENDING_PAYMENT)")
    public void tc31() {
        addToCart(customerId, product1, 1);
    ...
    @Test
    @DisplayName("TC_ORDER_32: Mark as Delivered khi đang SHIPPING")
    public void tc32() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "SHIPPING");
    ...
    @Test
    @DisplayName("TC_ORDER_33: Xác nhận nhận hàng bởi khách (Confirm Received)")
    public void tc33() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "SHIPPING");
    ...
    @Test
    @DisplayName("TC_ORDER_34: Khách xác nhận nhận hàng khi đơn chưa giao (Sai Status)")
    public void tc34() {
        Long orderId = createSampleOrder(customerId);
        ApiResponse res = orderService.confirmReceived(orderId, customerId);
        assertFalse(res.isSuccess());
    ...
    @Test
    @DisplayName("TC_ORDER_35: SECURITY - Khách xác nhận nhận hàng của người khác")
    public void tc35() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "DELIVERED");
    ...
    @Test
    @DisplayName("TC_ORDER_36: Lấy thống kê đơn hàng (Statistics)")
    public void tc36() {
        createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_37: Kiểm tra tổng tiền doanh thu trong thống kê")
    public void tc37() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "DELIVERED");
        ...
        // Bug TC_ORDER_37: Kiểm tra tính đúng đắn của doanh thu (mẫu test mong đợi
        // logic chặt chẽ hơn)
        assertEquals(2000.0, revenue, "BUG: Thống kê doanh thu không chính xác");
    }

    @Test
    @DisplayName("TC_ORDER_38: Cập nhật status nhiều lần (State machine check)")
    public void tc38() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "CONFIRMED");
        orderService.updateOrderStatus(orderId, "DELIVERED");
        ...
        // Bug TC_ORDER_38: Đơn đã giao (DELIVERED) thì không được phép chuyển sang
        // CANCELLED nữa
        assertFalse(res.isSuccess(), "BUG: Vẫn cho phép hủy đơn đã giao thành công");
    }

    @Test
    @DisplayName("TC_ORDER_39: Mark Shipping From Ready (Nội thành)")
    public void tc39() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_40: Cập nhật status đơn hàng đã từng hủy (Nghiệp vụ chặn ko cho đổi lại)")
    public void tc40() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_41: Khách hàng hủy đơn hàng (CONFIRMED)")
    public void tc41() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_42: Khách hàng hủy đơn hàng đang giao (SHIPPING) - Phải thất bại")
    public void tc42() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "SHIPPING");
        ApiResponse res = orderService.cancelOrderByCustomer(orderId, customerId, "Hủy ngang");
        // Bug TC_ORDER_42: Khách không được tự ý hủy khi đơn đã xuất kho đi giao
        // (SHIPPING)
        assertFalse(res.isSuccess(), "BUG: Khách vẫn hủy được đơn khi đang trên đường giao");
    }

    @Test
    @DisplayName("TC_ORDER_43: Khách hàng hủy đơn hàng đã giao (DELIVERED) - Phải thất bại")
    public void tc43() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "DELIVERED");
    ...
    @Test
    @DisplayName("TC_ORDER_44: Admin hủy đơn hàng")
    public void tc44() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_45: Hủy đơn hàng PENDING_PAYMENT (Xóa khỏi DB)")
    public void tc45() {
        addToCart(customerId, product1, 1);
        ApiResponse resOrder = orderService.createOrderFromCart(customerId, createReq("A", "SEPAY", 0.0));
        Long orderId = ((OrderResponse) resOrder.getData()).getOrderId();
    ...
    @Test
    @DisplayName("TC_ORDER_46: Kiểm tra lý do hủy (Cancel Reason)")
    public void tc46() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_47: Hủy đơn hàng đã CONFIRMED -> Kiểm tra Reserved Stock")
    public void tc47() {
        addToCart(customerId, product1, 5);
        Long id = ((OrderResponse) orderService.createOrderFromCart(customerId, createReq("A", "COD", 0.0)).getData())
                .getOrderId();
    ...
    @Test
    @DisplayName("TC_ORDER_48: Hủy đơn hàng đã xuất kho (READY_TO_SHIP) -> Không hoàn kho tự động")
    public void tc48() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "READY_TO_SHIP");

        // Giả sử logic nghiệp vụ: Đã xuất kho thì hủy ko tự cộng lại kho (phải nhập
        // tay)
        orderService.cancelOrder(orderId, "Hủy sau xuất");
        // Theo code, p.setReservedQuantity ko gọi nếu isExported=true
        // Ta ko kiểm tra stockQuantity vì stockQuantity chỉ trừ khi Export thực sự (nằm
        // ở service khác)
    }

    @Test
    @DisplayName("TC_ORDER_49: Hủy đơn hàng của người khác (Admin override test)")
    public void tc49() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_50: Hủy đơn hàng đã bị hủy trước đó")
    public void tc50() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_51: Hủy đơn khi không truyền lý do (Reason=null)")
    public void tc51() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_52: Hủy đơn hàng có nhiểu sản phẩm")
    public void tc52() {
        addToCart(customerId, product1, 1);
        addToCart(customerId, product2, 1);
        Long id = ((OrderResponse) orderService.createOrderFromCart(customerId, createReq("A", "COD", 0.0)).getData())
    ...
    @Test
    @DisplayName("TC_ORDER_53: Kiểm tra timestamp khi hủy (CancelledAt)")
    public void tc53() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_54: Admin hủy đơn hàng không tồn tại")
    public void tc54() {
        assertThrows(RuntimeException.class, () -> orderService.cancelOrder(9999L, "Reason"));
    }

    @Test
    @DisplayName("TC_ORDER_55: Hủy đơn hàng Online đã thanh toán (Hoàn tiền - TODO logic check)")
    public void tc55() {
        addToCart(customerId, product1, 1);
        Order order = orderRepository.findById(
                ((OrderResponse) orderService.createOrderFromCart(customerId, createReq("A", "SEPAY", 0.0)).getData())
                        .getOrderId())
                .get();
        ...
        assertTrue(res.getMessage().contains("hoàn lại"),
                "BUG_SUMMARY: Hệ thống không hiển thị thông báo hoàn tiền khi hủy đơn đã thanh toán");
    }

    // --- GROUP 5: DELIVERY & FULFILLMENT (TC_ORDER_56 - TC_ORDER_65) ---

    @Test
    @DisplayName("TC_ORDER_56: Xác nhận chuẩn bị hàng xong (READY_TO_SHIP)")
    public void tc56() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "CONFIRMED");
    ...
    @Test
    @DisplayName("TC_ORDER_57: Mark as Shipping từ READY_TO_SHIP")
    public void tc57() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "READY_TO_SHIP");
    ...
    @Test
    @DisplayName("TC_ORDER_58: Nhân viên lấy danh sách đơn chờ xuất kho")
    public void tc58() {
        createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_59: Kiểm tra trạng thái giao hàng GHN (Success Mock)")
    ...
    @Test
    @DisplayName("TC_ORDER_60: Kiểm tra trạng thái giao hàng GHN khi chưa có mã vận đơn")
    public void tc60() {
        Long orderId = createSampleOrder(customerId);
        ApiResponse res = orderService.getShippingStatus(orderId, customerId);
        assertFalse(res.isSuccess());
    ...
    @Test
    @DisplayName("TC_ORDER_61: Lấy danh sách đơn hàng theo CustomerId (Cho nhân viên)")
    public void tc61() {
        createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_62: Mark Delivered cho đơn hàng đã COMPLETED")
    public void tc62() {
        Long orderId = createSampleOrder(customerId);
        orderService.updateOrderStatus(orderId, "DELIVERED");
    ...
    @Test
    @DisplayName("TC_ORDER_63: Đồng bộ trạng thái từ GHN API")
    ...
    @Test
    @DisplayName("TC_ORDER_64: Xác nhận nhận hàng khi đơn đã CANCELLED")
    public void tc64() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_65: Cập nhật status admin (Get Shipping Status Admin)")
    public void tc65() {
        Long orderId = createSampleOrder(customerId);
    ...
    @Test
    @DisplayName("TC_ORDER_66: Đặt hàng với số lượng lớn (Boundary Check)")
    public void tc66() {
    ...
    @Test
    @DisplayName("TC_ORDER_67: Race Condition Simulation (Đặt hàng đồng thời)")
    public void tc67() {
    ...
    @Test
    @DisplayName("TC_ORDER_68: Đặt hàng khi Product có giá thay đổi")
    public void tc68() {
        addToCart(customerId, product1, 1);
    ...
    @Test
    @DisplayName("TC_ORDER_69: Kiểm tra định dạng mã đơn hàng (Regex Check)")
    public void tc69() {
        Long orderId = createSampleOrder(customerId);
        String code = orderRepository.findById(orderId).get().getOrderCode();
    ...
    @Test
    @DisplayName("TC_ORDER_70: Đặt hàng với phương thức thanh toán lạ")
    public void tc70() {
        addToCart(customerId, product1, 1);
    ...
    private Long initCustomer(String e, String p) {
        User u = userRepository
                .save(User.builder().email(e).password("1").role(com.doan.WEB_TMDT.module.auth.entity.Role.CUSTOMER)
                        .status(com.doan.WEB_TMDT.module.auth.entity.Status.ACTIVE).build());
    ...
    private CartItem addToCart(Long cId, Product p, int q) {
        Cart cart = cartRepository.findByCustomerId(cId).orElseGet(
                () -> cartRepository.save(Cart.builder().customer(customerRepository.findById(cId).get()).build()));
